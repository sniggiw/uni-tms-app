<template>
  <view class="loginPage">
    <view class="header">
      <view class="top">
        <view
          class="switchLanaguageBtn"
          @click="handleToggleLanguage('bottom')"
        >
          <text>{{
            languageList.find((item) => item.value === selectLanguage).text
          }}</text>
    ...
    <view class="main">
        ...
        <view class="form">
          ...
          <view class="rememberAndForgetPassword">
            <view
              ...
              @tap="handleToggleIsRememberPassword"
            >
              <view
                :class="[
                  'rememberPasswordBox',
                  form.isRememberPassword
          ...
          <view class="trackAndLoginBtns">
            ...
            <view class="btn login" @tap="loginNow">登录</view>
          </view>
      ...
      <view class="protocol">
        <view
          :class="['agreeBtn', form.isAgree ? 'iconAgree' : 'unAgree']"
          @tap="handleToggleAgree"
        ></view>
...
.loginPage {
  ...
  .header {
    width: 100%;
    height: 490rpx;
    background: url("@/static/imgs/login/headerBg.png") left top / 100% 100%
      no-repeat;
    overflow: hidden;
    ...
    .top {
      ...
      .onlineServiceBtn {
        ...
        width: 36rpx;
        height: 36rpx;
        background: url("@/static/imgs/login/iconOnlineService.png") left top /
          100% 100% no-repeat;
      }
    }
    ...
    .mid {
      ...
      .logo {
        ...
        width: 160rpx;
        height: 160rpx;
        background: url("@/static/imgs/login/logo.png") left top / 100% 100%
          no-repeat;
      }
  ...
  .main {
    ...
    .form {
      ...
      .inputContainer {
        ...
        .beforeExtra {
          ...
          .iconArrowDown {
            width: 20rpx;
            height: 10rpx;
            background: url("@/static/imgs/login/iconArrowDown.png") left top /
              100% 100% no-repeat;
          }
        }
      ...
      .rememberAndForgetPassword {
        ...
        .rememberPassword {
          ...
          .iconIsRememberPassword {
            background: url("@/static/imgs/login/iconRememberPassword.png") left
      ...
      .orLine {
        ...
        .leftLine {
          background: url("@/static/imgs/login/leftLine.png") left top / 100%
            100% no-repeat;
        }

        .rightLine {
          background: url("@/static/imgs/login/rightLine.png") left top / 100%
            100% no-repeat;
        }
      }
    ...
    .protocol {
      ...
      .agreeBtn {
        ...
        &.iconAgree {
          background: url("@/static/imgs/login/iconAgree.png") left top / 100%
            100% no-repeat;
        }
